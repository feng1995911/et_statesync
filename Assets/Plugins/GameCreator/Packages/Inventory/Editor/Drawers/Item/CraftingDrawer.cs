...
namespace GameCreator.Editor.Inventory
{
    ...
    public class CraftingDrawer : TBoxDrawer
    {
        ...
        protected override void CreatePropertyContent(VisualElement container, SerializedProperty property)
        {
            ...
            SerializedProperty canCombine = property.FindPropertyRelative("m_CanCombine");
            ...
            PropertyField fieldCanCombine = new PropertyField(canCombine);
            ...
            contentCraft.Add(fieldCanCombine);
