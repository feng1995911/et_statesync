...
namespace DaimahouGames.Runtime.Abilities
{
    ...
    public class RuntimeProjectile : MonoBehaviour
    {
        ...
        private Collider m_ProjectileCollider;
        ...
        {
            m_ProjectileCollider = GetComponent<Collider>();
            if (m_ProjectileCollider == null)
            {
                var sphereCollider = gameObject.AddComponent<SphereCollider>();
                sphereCollider.radius = 0.1f;
                m_ProjectileCollider = sphereCollider;
            }
            
            m_ProjectileCollider.isTrigger = true;
        }
