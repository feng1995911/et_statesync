...
{
public sealed class ReferenceBox : VisualElement
{
    ...
    public ReferenceBox(string title, bool isExpanded, IIcon headerIcon)
    {
        ...
        {
            image = headerIcon?.Texture ?? new IconCubeSolid(ColorTheme.Type.Blue).Texture,
