...
namespace Fullscreen.LogicBlock.Runtime
{
    ...
    [Serializable]
    [HideLabelsInEditor]
    public class BlockGetPositionReference : PropertyTypeGetPosition
    {
        ...
        public override Vector3 Get(Args args)
        {
            ...
            {
                Debug.LogWarning("Invalid Block reference parameters for position.");
                return Vector3.zero;
            }
            ...
            return reference is Vector3 position ? position : Vector3.zero;
        }
        ...
        public BlockGetPositionReference() : base() { }

        public BlockGetPositionReference(Block block, string instructionListId, string referenceName) : this()
        {
        ...
        public static PropertyGetPosition Create() => new PropertyGetPosition(new BlockGetPositionReference());

        public static PropertyGetPosition Create(Block block, string instructionListId, string referenceName)
            => new PropertyGetPosition(new BlockGetPositionReference(block, instructionListId, referenceName));
