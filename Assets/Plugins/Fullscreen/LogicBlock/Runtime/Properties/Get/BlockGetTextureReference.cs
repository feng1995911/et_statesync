...
namespace Fullscreen.LogicBlock.Runtime
{
    ...
    [Image(typeof(IconTexture), ColorTheme.Type.TextLight)]
    [Description("A texture reference from a Block")]
    [Serializable]
    [HideLabelsInEditor]
    public class BlockGetTextureReference : PropertyTypeGetTexture
    {
        ...
        public override Texture Get(Args args)
        {
            ...
            {
                Debug.LogWarning("Invalid Block reference parameters for texture.");
                return null;
            }
            ...
            return reference is Texture texture ? texture : null;
        }
        ...
        public BlockGetTextureReference() : base() { }

        public BlockGetTextureReference(Block block, string instructionListId, string referenceName) : this()
        {
        ...
        public static PropertyGetTexture Create() => new PropertyGetTexture(new BlockGetTextureReference());

        public static PropertyGetTexture Create(Block block, string instructionListId, string referenceName)
            => new PropertyGetTexture(new BlockGetTextureReference(block, instructionListId, referenceName));
