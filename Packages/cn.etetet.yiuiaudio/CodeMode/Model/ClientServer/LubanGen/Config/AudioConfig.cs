...
namespace ET
{
    ...
    public sealed partial class AudioConfig : Luban.BeanBase
    {
        public AudioConfig(ByteBuf _buf) 
        {
            ...
            {int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);AudioNames = new System.Collections.Generic.List<string>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { string _e0;  _e0 = _buf.ReadString(); AudioNames.Add(_e0);}}
