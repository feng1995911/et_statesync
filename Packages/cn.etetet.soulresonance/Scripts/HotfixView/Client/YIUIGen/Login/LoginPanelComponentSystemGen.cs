...
namespace ET.Client
{
    ...
    public static partial class LoginPanelComponentSystem
    {
        ...
        private static void UIBind(this LoginPanelComponent self)
        {
            ...
            self.u_ComU_inputEmail = self.UIBase.ComponentTable.FindComponent<TMPro.TMP_InputField>("u_ComU_inputEmail");
            self.u_ComU_inputPassword = self.UIBase.ComponentTable.FindComponent<TMPro.TMP_InputField>("u_ComU_inputPassword");
